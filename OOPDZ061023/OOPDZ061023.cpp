...
int main() {
    ...
    */
    setlocale(LC_ALL, "");
    Date* date1 = new Date(25, 03, 2023);
    Date* date2 = new Date(25, 03, 2007);
    
    User u1("ApS", "Петрыкин Артём Сергеевич", "2007ARTeM__", date1, date2, "male", 567414);
    users.push_back(u1);
    users[0].print();
    cout << endl;

    Admin a1("ApSA", "Петрыкин Артём Сергеевич", "20072007ARTeM__", date1, date2, "male", 5674142, false);
    admins.push_back(a1);
    admins[0].print();
    cout << endl;
